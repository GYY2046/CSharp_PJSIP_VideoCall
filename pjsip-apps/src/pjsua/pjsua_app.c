...
static pj_status_t app_init(void)
{
	...
	param.enc_fmt.det.vid.size.w = 1920;
	param.enc_fmt.det.vid.size.h = 1080;
	...
	param.dec_fmtp.param[0].val = pj_str("42e028");
	//1920x1080
	//param.dec_fmtp.param[0].val = pj_str("42e028");
	...
	param.enc_fmt.det.vid.avg_bps = 4096000;
	param.enc_fmt.det.vid.max_bps = 8192000;

	param.dec_fmt.det.vid.avg_bps = 4096000;
	param.dec_fmt.det.vid.max_bps = 8192000;
