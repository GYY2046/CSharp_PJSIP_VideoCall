...
public:
    ...
    void swig_connect_director(SWIG_Callback0_t callbackonCallState, SWIG_Callback1_t callbackonCallTsxState, SWIG_Callback2_t callbackonCallMediaState, SWIG_Callback3_t callbackonCallSdpCreated, SWIG_Callback4_t callbackonStreamCreated, SWIG_Callback5_t callbackonStreamDestroyed, SWIG_Callback6_t callbackonDtmfDigit, SWIG_Callback7_t callbackonDtmfEvent, SWIG_Callback8_t callbackonCallTransferRequest, SWIG_Callback9_t callbackonCallTransferStatus, SWIG_Callback10_t callbackonCallReplaceRequest, SWIG_Callback11_t callbackonCallReplaced, SWIG_Callback12_t callbackonCallRxOffer, SWIG_Callback13_t callbackonCallRxReinvite, SWIG_Callback14_t callbackonCallTxOffer, SWIG_Callback15_t callbackonInstantMessage, SWIG_Callback16_t callbackonInstantMessageStatus, SWIG_Callback17_t callbackonTypingIndication, SWIG_Callback18_t callbackonCallRedirected, SWIG_Callback19_t callbackonCallMediaTransportState, SWIG_Callback20_t callbackonCallMediaEvent, SWIG_Callback21_t callbackonCreateMediaTransport, SWIG_Callback22_t callbackonCreateMediaTransportSrtp);
...
private:
    ...
    SWIG_Callback7_t swig_callbackonDtmfEvent;
    SWIG_Callback8_t swig_callbackonCallTransferRequest;
    SWIG_Callback9_t swig_callbackonCallTransferStatus;
    SWIG_Callback10_t swig_callbackonCallReplaceRequest;
    SWIG_Callback11_t swig_callbackonCallReplaced;
    SWIG_Callback12_t swig_callbackonCallRxOffer;
    SWIG_Callback13_t swig_callbackonCallRxReinvite;
    SWIG_Callback14_t swig_callbackonCallTxOffer;
    SWIG_Callback15_t swig_callbackonInstantMessage;
    SWIG_Callback16_t swig_callbackonInstantMessageStatus;
    SWIG_Callback17_t swig_callbackonTypingIndication;
    SWIG_Callback18_t swig_callbackonCallRedirected;
    SWIG_Callback19_t swig_callbackonCallMediaTransportState;
    SWIG_Callback20_t swig_callbackonCallMediaEvent;
    SWIG_Callback21_t swig_callbackonCreateMediaTransport;
    SWIG_Callback22_t swig_callbackonCreateMediaTransportSrtp;
    void swig_init_callbacks();
};
